...
var Chessground = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.componentDidMount = function componentDidMount() {
    this.cg = (0, _chessground.Chessground)(this.el, this.buildConfigFromProps(this.props));
  };
...
_defineProperty(Chessground, "propTypes", {
  ...
  check: _propTypes["default"].oneOfType([_propTypes["default"].string, _propTypes["default"].bool]),
